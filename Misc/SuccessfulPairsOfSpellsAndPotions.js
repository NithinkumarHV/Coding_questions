/*
    ...
    A spell and potion pair is considered successful if the product of their strengths is at 
    least success.
...
function successfullPairs(spells, potions, success) {
  let result = [];
...
console.log(successfullPairs([5, 1, 3], [1, 2, 3, 4, 5], 7));
